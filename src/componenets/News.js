...
export default class News extends Component {
    ...
    async componentDidMount(){
        let url = `https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=9ba4796f37b1465bb15222ed537beeb3&page=1&pageSize=20`;
    ...
    handleNext = async()=>{
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=9ba4796f37b1465bb15222ed537beeb3&page=${this.state.page + 1}&pageSize=20`; 
        let data = await fetch(url)
        let parsedData = await data.json()
        console.log(parsedData)
        this.setState({
